...
public class NotificationUtils {
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        Intent ignoreReminderIntent = new Intent(context, RelocationIntentService.class);
        ignoreReminderIntent.setAction(RelocationTasks.ACTION_DISMISS_NOTIFICATION);
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        Intent incrementWaterCountIntent = new Intent(context, RelocationIntentService.class);
        incrementWaterCountIntent.setAction(RelocationTasks.ACTION_INCREMENT_WATER_COUNT);
